...
sudo taskset --cpu-list 10 ./no_desc_buf 10.20.2.1 configs/node-1-link.csv /dev/ptp0 120 1 1 
sudo taskset --cpu-list 10 ./no_desc_buf 10.20.2.2 configs/node-2-link.csv /dev/ptp0 120 1 1
...
sudo ethtool -L ens2np0 rx 3
sudo ethtool -L ens2np0 tx 3
```
...
mqnic_tx.c file (mqnic_start_xmit method)
