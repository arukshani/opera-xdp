...
sudo taskset --cpu-list 11 ./opera_emulator 10.1.0.1 configs/node-1-link.csv /dev/ptp0 120 1 1 
sudo taskset --cpu-list 11 ./opera_emulator 10.1.0.2 configs/node-2-link.csv /dev/ptp0 120 1 1 
```